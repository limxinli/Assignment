...
<body>
	...
	<div class="overlay ">
		<h3>
			LIFE IS STRANGE: LIMITED EDITION <i class="fa fa-angle-double-right "></i>
		</h3>
	...
	<%
		...
		String sql = "Select *,genre_name from game_data gd, genre g, game_genre gg WHERE g.genre_id = gg.genre_id AND gg.game_id = gd.game_id AND game_title='Life is Strange: Limited Edition'";
