...
<body>
					...
					<li><div class="dropdown">
							...
							<div id="myDropdown" class="dropdown-content">
								...
								<a href="horror.jsp">Horror</a> <a
									href="rpg.jsp">RPG</a> <a href="shooter.jsp" class="active-menu-item">Shooter</a>
							</div>
						</div></li>
	...
	<%
		...
		String sql = "Select * from game_data where game_title='Far Cry Primial Collectors Edition'";
