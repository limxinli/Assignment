...
<body>
	...
	<section class="headline-sec">
		<div class="overlay ">
			<h3>
				ON SALE NOW <i class="fa fa-angle-double-right "></i>
			</h3>
			...
			<div class="row">
				<div class="col-md-12" style="min-height: 800px;">
					<div class="alert alert-info">
						This is the blank page that you can use to customize or add you
						content in this template. For more templates keep looking <a
