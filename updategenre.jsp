...
<body>
	...
	<section class="headline-sec">
		<div class="overlay ">
			<h3>
				UPDATE GENRE <i class="fa fa-angle-double-right "></i>
			</h3>
	...
	<section>
		<form action="updategenreprocess.jsp">
			<div class="gamedata">
				Enter Genre ID to update: <input type="text" name="genreid" id="genreid" class="form-control"><br>
				New Genre Name: <input type="text" name="genrename" id="genrename" class="form-control">
			</div>
			<input type="submit" class="btn btn-info" id="delete" value="Update">
		</form>
	</section>
