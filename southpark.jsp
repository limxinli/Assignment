...
<!--[if IE]>
        ...
        <![endif]-->
<title>South Park: The Stick of Truth</title>
...
<body>
	...
	<div class="overlay ">
		<h3>
			SOUTH PARK: THE CTICK OF TRUTH <i class="fa fa-angle-double-right "></i>
		</h3>
	...
	<%
		...
		String sql = "Select * from game_data where game_title='South Park: The Stick of Truth'";
